...
- [Addressing Modes](wiki/coa/addressing-modes.md) - immediate, direct, indexed, relative, stack/zero-address. #high-yield
- [I/O, Interrupts, and DMA](wiki/coa/io-interrupts-dma.md) - memory-mapped I/O, vectored interrupts, DMA. #high-yield
...
- [SQL and Query Languages](wiki/dbms/sql-and-query-languages.md) - DDL, DML, views, grouping, relational algebra/calculus. #high-yield
...
- [Virtual Memory](wiki/os/virtual-memory.md) - OS page mapping and replacement concepts connected to COA cache locality.
- [Indexing and Buffering](wiki/dbms/indexing-and-buffering.md) - DBMS page-oriented storage connected to COA cache and memory hierarchy.
